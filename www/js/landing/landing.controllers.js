...
.controller('welcomeCtrl', function($timeout, menuService, outletService, outletWarningStatusService, $scope, $http, $rootScope, $state, $ionicPopover, $ionicPopup, $ionicLoading) {
