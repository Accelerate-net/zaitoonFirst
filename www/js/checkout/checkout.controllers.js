angular.module('checkout.controllers', [])
    ...
    .controller('CheckoutCtrl', function($timeout, locationChangeRouteTrackerService, ConnectivityMonitor, trackOrderService, $scope, $state, $http, ProfileService, $rootScope, products, CheckoutService, couponService, outletService, $ionicPopover, $ionicPopup, $ionicPlatform, $ionicLoading) {
